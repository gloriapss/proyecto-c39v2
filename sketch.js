 ...
 * En este proyecto, debes practicar y aplicar lo aprendido en clase. En este proyecto, el
 * juego canguro en la selva incluye un código para reiniciar el juego cuando se
 * presiona el botón de reinicio. Además, intenta agregar una condición ganadora al
 * juego.
 */
...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
    ...
    //asigna escala y vida útil al arbusto      
    shrub.scale = 0.05;
     //asigna vida útil a la variable
    shrub.lifetime = 400;
